<?php
				...
				?>
                      ...
                      if(get_the_category()) {_e (' in ', 'seo-grid'); the_category(', ');}
                      _e(' by ', 'seo-grid');
                      the_author_posts_link(); ?></em></p>
					  <?php else: ?>
                      <h2><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title(); ?>"><?php the_time( get_option( 'date_format' ) ) ?></a></h2><p class="postmetadata"><em><?php if(get_the_category()) {_e (' in ', 'seo-grid'); the_category(', ');}
                      _e(' by ', 'seo-grid');
                      the_author_posts_link(); ?></em></p>
<?php
					  endif;
